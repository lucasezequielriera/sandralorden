...
export default function LoginPage() {
  ...
  const checkRecoverySession = useCallback(async () => {
    ...
    if (roleRow?.role !== "client") {
      ...
      setError(
        "Este enlace solo sirve para activar tu cuenta de cliente. Si ya tienes contraseña, vuelve al inicio de sesión e introdúcela ahí."
      );
      setRecoveryReady(false);
      return;
    }
  ...
  const handleSetPassword = async (e: React.FormEvent) => {
    ...
    toast.success("Contraseña creada. Entrando a tu panel…");
    router.push("/cliente");
    router.refresh();
  };
        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-warm-gray-400 mt-2">
              Usa tu email de compra y elige una contraseña segura para acceder a tu panel de cliente.
            </p>
          </div>
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-warm-gray-400 mt-3 leading-relaxed px-1">
            ¿Primera vez después de contratar? Abre el enlace del correo de confirmación para crear tu contraseña. A partir
            de ahí podrás entrar siempre desde aquí y ver tus planes y tu progreso.
          </p>
        </div>
