...
export async function generateMetadata({
  ...
  const path = locale === "es" ? "/programa-de-90-dias" : "/en/90-days-program";
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: {
        es: `${SITE_URL}/programa-de-90-dias`,
        en: `${SITE_URL}/en/90-days-program`,
        "x-default": `${SITE_URL}/programa-de-90-dias`,
      },
    },
    openGraph: {
      type: "website",
...
export default async function Programa90DiasPage() {
